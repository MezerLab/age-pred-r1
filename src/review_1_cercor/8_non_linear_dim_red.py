...
NUM_PCS = 30 # pca_idx
pca = manifold.LocallyLinearEmbedding(n_components=NUM_PCS, n_neighbors=50)
...
plt.ylabel("real age")
plt.xlim(0,100)
plt.title("Age prediction LLE R1") 
plt.savefig('./reports/figures/rebuttal/lle/LLE_pca25_mean.eps', format='eps')
plt.close()

np.mean(error_young), np.mean(error_old)
#(3.857896232932039, 9.458886962239397)
...
plt.ylabel("real age")
plt.xlim(0,100)
plt.title("Age prediction LLE CT") 
plt.savefig('./reports/figures/rebuttal/lle/LLE_pca25_mean_ct.eps', format='eps')
plt.close()

np.mean(error_young), np.mean(error_old)
#(3.857896232932039, 9.458886962239397)

#(3.440282332090566, 9.576643244568059)
...
plt.savefig('./reports/figures/rebuttal/lle/young_ct_r1_stats_lle_' + str(p) + '.svg', format='svg')
plt.close()
...
plt.savefig('./reports/figures/rebuttal/lle/old_ct_r1_stats_lle_' + str(p) + '.svg', format='svg')
plt.close()
...
plt.savefig('./reports/figures/rebuttal/lle/pca_vs_lle_r1_young_' + str(p) + '.svg', format='svg')
plt.close()
...
plt.savefig('./reports/figures/rebuttal/lle/pca_vs_lle_r1_old_' + str(p) + '.svg', format='svg')
plt.close()
...
plt.savefig('./reports/figures/rebuttal/lle/pca_vs_lle_ct_young_' + str(p) + '.svg', format='svg')
plt.close()
...
plt.savefig('./reports/figures/rebuttal/lle/pca_vs_lle_ct_old_' + str(p) + '.svg', format='svg')
plt.close()
